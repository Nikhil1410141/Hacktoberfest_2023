...
//Approach:-
//We will use cyclic sort in this question because it is given that:- 
// 1. Time complexity :- O(n)
// 2. Space complexity :- O(1)
// Cyclic sort algo sorts the given array in place and does not require additional space. So it will be the best approach for solving this question.
//We will ignore the negative elements, because positive element is asked.
//In this way, the first element which is not present in its correct position (index), will be th answer.
